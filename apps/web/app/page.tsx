...
export default function HygieneHeroPage() {
  return (
    <div className="min-h-screen bg-[#a9cde5] flex items-center justify-center p-2 md:p-4 font-sans touch-none">
      ...
      <div className="relative w-[min(100%,calc((100vh-1rem)*16/9))] max-w-[1366px] aspect-[16/9] overflow-hidden border-[4px] border-black rounded-[1.8rem] shadow-[0_10px_25px_rgba(0,0,0,0.24)] flex flex-col bg-[#d9eff9]">
